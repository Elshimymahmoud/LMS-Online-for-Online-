...
//            }
    ...
    public function update($id, array $input, $image = false)
    {
        ...
        $user->sec_name_ar = $input['sec_name_ar'];
        $user->third_name_ar = $input['third_name_ar'];
        $user->fourth_name_ar = $input['fourth_name_ar'];
        ...
        $user->national_id_number = isset($input['national_id_number']) ? $input['national_id_number'] : NULL;
        // $user->name_ar = isset($input['name_ar']) ? $name_ar : NULL;
        $user->passport_number = isset($input['passport_number']) ? $input['passport_number']: NULL;
        $user->nationality = isset($input['nationality']) ? $input['nationality']: NULL;
        $user->educational_qualification = isset($input['educational_qualification']) ? $input['educational_qualification']: NULL;
        ...
        if ($image) {
            $user->avatar_location = $image->store('/avatars', 'local');
        } else {
