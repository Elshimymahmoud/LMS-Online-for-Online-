...
class Bundle extends Model
{
    ...
    protected $fillable = ['category_id', 'title', 'title_ar', 'slug', 'description','description_ar', 'price', 'course_image', 'start_date', 'published','free', 'featured', 'trending', 'popular', 'meta_title', 'meta_description', 'meta_keywords','user_id'];
