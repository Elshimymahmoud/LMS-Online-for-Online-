...
class BundlesController extends Controller
{
    ...
    public function all()
    {
       ...
       return view( $this->path.'.bundles.index-new', compact('bundles','type', 'purchased_bundles', 'recent_news','featured_courses','categories','coursesTypes'));

        // return view( $this->path.'.bundles.index', compact('bundles','type', 'purchased_bundles', 'recent_news','featured_courses','categories'));
    }
    ...
    public function show($bundle_slug)
    {
        ...
        $relatedCourses=Course::where('category_id',$bundle->category_id)->take(3)->get();
        

        return view( $this->path.'.bundles.show-new', compact('bundle', 'purchased_bundle', 'recent_news', 'bundle_rating','bundle_rating','courses','total_ratings','is_reviewed','relatedCourses'));
    }
