...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::post('storeUserToCourse', [UserController::class, 'storeUserToCourse'])->name('user.storeUserToCourse');
        Route::post('storeUserToGroup', [UserController::class, 'storeUserToGroup'])->name('user.storeUserToGroup');
        ...
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::get('addUserToCourse', [UserController::class, 'addUserToCourse'])->name('user.addToCourse');
            Route::get('addUserToGroup', [UserController::class, 'addUserToGroup'])->name('user.addToGroup');
            Route::get('addUserToCourse/ajax/user_id/{course_id}', [UserController::class, 'addUserToCourseAjax'])->name('user.addUserToCourseAjax');
