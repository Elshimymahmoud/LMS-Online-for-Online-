...
class CreateCourseGroupImpactsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('course_group_impacts', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('course_group_id');
            $table->unsignedBigInteger('user_id');
            $table->text('impact');
            $table->text('impact_ar');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('course_group_impacts');
    }
}
