        ...
        <div class="cert-container" @if(@$course->type_id==1 )style="margin-top:100px;font-size:30px;" @elseif(@$course->type_id==2 ) style="margin-top:70px" @endif>
            ...
            <div class="col-12">
                ...
                <p class="sub-title ">
                   ...
                   و لمدة ( {{$certificate->course->id==6? @$data['course']->courseDurationByCourseLocationId($data['courseLocId'])['hours']+2:@$data['course']->courseDurationByCourseLocationId($data['courseLocId'])['hours']}} ) 
                    @if(in_array(@$data['course']->courseDurationByCourseLocationId($data['courseLocId'])['hours'],[3,4,5,6,7,8,9,10]))
