    ...
    <div style="position: relative;text-align: center"
        ...
        <div  class="col-12 text-block align-self-center">
            ...
            {{-- @if($data['location']->name!='Online') --}}
                 ...
                 <p class="text-left fntCursive fs-unset ml-90  mb-0"><span class="font-weight-bold fntCursive"> And fulfilled the requirements of  ( {{ @$certificate->course->courseDurationByCourseLocationId($data['courseLocId'])['hours']}} ) 
                    @if(in_array(@$certificate->course->courseDurationByCourseLocationId($data['courseLocId'])['hours'],[3,4,5,6,7,8,9,10]))
