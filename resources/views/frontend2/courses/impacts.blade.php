                            ...
                            <div class="course-single-text">
                                ...
                                <div class="course-title mt10 headline relative-position">
                                    <h3 style="margin: 30px 0">
                                        <b>
                                            @if (Lang::locale() == 'en'){{ $ImpactMeasurement->name ? $ImpactMeasurement->name : $ImpactMeasurement->name_ar }}@else {{ $ImpactMeasurement->name_ar ? $ImpactMeasurement->name_ar : $ImpactMeasurement->name }} @endif
                                        </b>
                                    </h3>
                                </div>
