    ...
    <tr>
        ...
        <td align="center" Simpli bgcolor="#F0F0F0" data-composer>
                ...
                <tr>
                    <td align="center" class="center-text">
                        <img style="width:120px;border:0px;display: inline!important;"
                             src="{{asset('images/logo.png')}}" width="120" border="0" editable="true" Simpli
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" class="row" role="presentation" width="640"
                   style="width:640px;max-width:640px;" Simpli>
                <!-- simpli-header-5 -->
                <tr>
                    <td align="center">

                        <table border="0" align="center" cellpadding="0" cellspacing="0" class="row container-padding10"
                                ...
                                <td align="center" Simpli bgcolor="#F4F4F4" style="border-radius: 36px;">
                                    ...
                                    <div style="    height: 341px;">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" background="{{asset('images/lock2.jpg')}}"
                                                    data-bg-image
                                                    style="background-size:cover;background-position:center; border-radius: 36px;">

                                                    <!-- Content -->
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                           role="presentation" class="row" width="600"
                                                           style="width:600px;max-width:600px;">
                                                        <tr>
                                                            <td height="640" valign="bottom" class="container-padding"
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td class="center-text" Simpli align="center"
                                                ...
                                                <singleline>
                                                    <div mc:edit Simpli style="padding-top:6px">
                                                        YOUR TICKET CODE
                                                    </div>
                                                </singleline>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="center-text" Simpli align="center"
                                                style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:38px;line-height:54px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        TICKET LINK
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="center-text" Simpli align="center"
                                                ...
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        Click on the button below to see if there is any update
                                                        in your ticket
                                                    </div>
                                                </singleline>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="center" Simpli bgcolor="#FAFAFA"
                                                            style="border-radius: 10px;border: 2px dotted #DDDDDD;">
                                                            <!-- Content -->
                                                            <table border="0" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td class="center-text" Simpli align="center"
                                                                        style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:22px;line-height:26px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                TICKET CODE: <span
                                                                                        style="color:#1898c2;
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="center" Simpli bgcolor="#ff7775"
                                                            ...
                                                            <![endif]-->
                                                            <singleline>
                                                                <a href="{{ route('tickets.show', ['ticket' => $ticket->code]) }}"
                                                                   target="_blank" mc:edit
                                                                   style="font-family:'Catamaran',Arial,Helvetica,
                                                                   sans-serif;font-size:16px;line-height:20px;
                                                                   font-weight:700;font-style:normal;color:#FFFFFF;
                                                                   text-decoration:none;letter-spacing:0px;padding:
                                                                   15px 35px 15px 35px;display: inline-block;
                                                                   "><span>SEE YOUR TICKET</span></a>
                                                            </singleline>
                                                            <!--[if (gte mso 9)|(IE)]>
                                                            </td>
                                                            <td align="center" width="35"></td>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
                   style="width:100%;max-width:100%;" Simpli>
                <!-- simpli-footer -->
