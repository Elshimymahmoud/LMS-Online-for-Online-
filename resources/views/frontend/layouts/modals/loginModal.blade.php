        ...
        <div class="model-content">
            <div class="head-model">
                <ul class="list-unstyled d-flex list-head">
                    ...
                    <li class="active tabs active list-unstyled d-flex list-head" id="tab01">@lang('labels.frontend.modal.login')</li>
                    <li class="tabs  list-unstyled d-flex list-head" id="tab02">@lang('labels.frontend.modal.register')</li>
                </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">@lang('validation.attributes.frontend.email')</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">@lang('validation.attributes.frontend.password')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label for="remember_me"> @lang('labels.frontend.passwords.remember_me') </label>
                                </div>
                            </div>
                            <div class="col-md-4" style="padding: 0;">
                                <div class="form-group">
                                    <a style="color: #fff;" href="{{ route('frontend.auth.password.reset') }}">@lang('labels.frontend.passwords.forgot_password')</a>
                                </div>
                            </div>
                ...
                <fieldset id="tab021" class="body-content body-register">
                    <form id="registerForm" class="contact_form" action="#" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">{{ __('validation.attributes.frontend.nameAr') }}</label>
                                    {{ html()->text('name_ar')->class('form-control mb-0')->placeholder(__('validation.attributes.frontend.nameAr'))->attribute('maxlength', 191) }}
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">{{ __('validation.attributes.frontend.national_id_number') }}</label>
                            ...
                            @if (config('registration_fields') != null)
                                ...
                                @foreach ($fields as $item)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">{{__('labels.backend.general_settings.user_registration_settings.fields.' . $item->name)  }}</label>
                                            <input type="{{ $item->type }}" class="form-control mb-0"
                                                value="{{ old($item->name) }}" name="{{ $item->name }}" id="{{ $item->name }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">{{__('validation.attributes.frontend.password')}}</label>
                                    {{ html()->password('password')->class('form-control mb-0')->placeholder(__('validation.attributes.frontend.password')) }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">{{__('validation.attributes.frontend.password_confirmation')}}</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label for="terms">
                                        <a href="#">{{__('validation.attributes.frontend.conditions')}} </a>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" style="margin-bottom: 0">
                                    <button type="submit" style="background-color:##3bcfcb" class="ml-auto" id="register"><span>@lang('labels.frontend.modal.register')</span></button>
                                </div>
                            </div>
                        </div>
                    </form>
