                ...
                <div class="container">
                    ...
                    <div class="col-sm-12 col-md-6   wow fadeInUp ptb-50  mt-0">
                        ...
                        <div class="register">
                           ...
                           <h3 class=" register-title1">انضم الي منصة تمهير</h3>
                           ...
                           <form id="registerForm" class="contact_form" action="#" method="post">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="text" name="first_name" id="" placeholder=" {{ __('validation.attributes.frontend.first_name') }}"maxlength="191" minlength="2" required>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                <input type="text" name="last_name" id="" placeholder="{{ __('validation.attributes.frontend.last_name') }} "maxlength="191" minlength="2" required>
                                <i class="fa fa-user"></i>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="text" name="third_name" id="" placeholder=" {{ __('validation.attributes.frontend.third_name') }}" maxlength="191" minlength="2" required>
                                <i class="fa fa-user"></i>
                                <span id="third-name-error" class="text-danger"></span>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                <input type="text" name="fourth_name" id="" placeholder="{{ __('validation.attributes.frontend.fourth_name') }} " maxlength="191" minlength="2" required>
                                <i class="fa fa-user"></i>
                                <span id="fourth-name-error" class="text-danger"></span>
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <input type="text" name="name_ar" id="" placeholder="  {{ __('validation.attributes.frontend.first_name_ar') }} ">
                                  <i class="fa fa-user"></i>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <input type="text" name="sec_name_ar" id="" placeholder="  {{ __('validation.attributes.frontend.sec_name_ar') }} ">
                                  <i class="fa fa-user"></i>
                                  <span id="sec_name-ar-error" class="text-danger"></span>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <input type="text" name="third_name_ar" id="" placeholder="  {{ __('validation.attributes.frontend.third_name_ar') }} ">
                                  <i class="fa fa-user"></i>
                                  <span id="third_name-ar-error" class="text-danger"></span>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <input type="text" name="fourth_name_ar" id="" placeholder="  {{ __('validation.attributes.frontend.fourth_name_ar') }} ">
                                  <i class="fa fa-user"></i>
                                  <span id="fourth_name-ar-error" class="text-danger"></span>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="email" name="email" placeholder="{{ __('validation.attributes.frontend.email') }} " id="">
                                  ...
                                  @elseif($item->type == 'textarea')
                                      <div class="contact-info mb-2 col-md-10">
                                          ...
                                          <textarea name="{{ $item->name }}"
                                              placeholder="{{ __('labels.backend.general_settings.user_registration_settings.fields.' . $item->name) }}"
                                              class="form-control mb-0" cols="5" rows="2">{{ old($item->name) }}</textarea>
                                      </div>
                                  @endif
                              @endforeach
                          @endif
                          <div class="col-md-6">
                            <div class="form-group">
                              <input  type="password" name="password" placeholder="{{__('validation.attributes.frontend.password')}} "  id="">
                          ...
                          <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <input  type="password" name="password_confirmation" placeholder="{{__('validation.attributes.frontend.password_confirmation')}} "  id="">
                                <i class="fa fa-lock"></i>
                                <p class="input-message"> يجب ان لا تقل كلمة المرور عن ٨ احرف</p>
                           ...
                           <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <label for="terms">
                                  <a class='link-terms' href="#">{{__('validation.attributes.frontend.conditions')}} </a>
                              </label>
                          </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                <input class="submit" type="submit" name="submit" value="انشيء الحساب"  id="">
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <a href="/login" > <span style="color: green;"> ألديك حساب؟</span> سجل دخولك هنا  </a>
                              </div>
                           </div>
              ...
              $(document).on('submit','#registerForm', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#third-name-error').empty()
                            $('#fourth-name-error').empty()
                            $('#email-error').empty()
                            $('#phone').empty()
                            ...
                            if (data.errors) {
                                ...
                                if (data.errors.sec_name-ar-error) {
                                    ...
                                    $('#fourth_name-ar-error').html(data.errors.fourth_name-ar[0]);
                                }
                                // ********
                                ...
                                if (data.errors.national_id_number) {
                                    $('#national-id-number-error').html(data.errors.national_id_number[0]);
                                }
                                if (data.errors.phone) {
                                    $('#phone').html(data.errors.phone[0]);
                                }
