                ...
                <div class="row">
                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-12 col-md-8 plan  wow fadeInUp ptb-50  mt-0">
                            <div class="plan1">
                                <p class="color-primary text-color"> @lang('custom-menu.nav-menu.plan2020')‬‬</p>
                                <img src="{{ asset('images/plan/plan2020-1.jpg') }}" alt="">
                                <p class="plan-text">
                            ...
                            <!-- <img  class="img-header" src="http://ivorytraining.com/mail_temp_ar/tr_plan/2018_200.PNG" alt="" width="1000" height="50"> -->
                                ...
                                <img src="{{ asset('images/plan/plan2020-2.jpg') }}" alt="">
                                <a class=" color-primary link" target="_blank"
                            ...
                            <!-- <img  class="img-header" src="http://ivorytraining.com/mail_temp_ar/tr_plan/2018_200.PNG" alt="" width="1000" height="50"> -->
                                ...
                                <img src="{{ asset('images/plan/plan2020-3.jpg') }}" alt="">
