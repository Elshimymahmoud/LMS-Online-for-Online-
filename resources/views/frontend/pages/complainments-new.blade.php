                    ...
                    <div class="col-sm-12 col-md-12 plan  wow fadeInUp ptb-50  mt-0">
                        <div class="plan1">
                            <section class="welcome">
                                        ...
                                        <div class="first">
                                            <hr>
                                            <h3 class="color-primary text-color">نموذج شكاوي</h3>
                                            <div class="middle-welcome">
                                                ...
                                                {{--  --}}
                                                  ...
                                                  <ul class="options-list pl-4">
                                                      ...
                                                      @if (sizeof($question->options) && $question->question_type=="multiple_choice")
                                                          ...
                                                          <div class="radio">
                                                            <label>
                                                                <input required type="radio" name="{{ $question->id }}-options"
                                                                    value="{{ $option->id }}" />
                                                      ...
                                                      @elseif (sizeof($question->options) && $question->question_type=="drop_down")
                                                          <select required name="{{ $question->id }}-options"    class="form-control">
                                                          @foreach ($question->options as $option)
                                                      ...
                                                      @else
                                                          @switch($question->question_type)
                                                                  @case("paragraph")
                                                                  <textarea required type="text" class="form-control editor"   placeholder="paragraph" style="height:100px" name="{{ $question->id }}-options">{{ @test_res($test_result->id, $question->id)->option_id }}</textarea>
                                                                  @break
                                                                  @case("short_answer")
                                                                  <input required type="text" class="form-control" value="{{ @test_res($test_result->id, $question->id)->option_id }}" placeholder="short_answer" name="{{ $question->id }}-options" />
                                                                  @break
                                                                  @case("date")
                                                                  <input required type="text" class="form-control datepicker" value="{{ @test_res($test_result->id, $question->id)->option_id }}" placeholder="date" name="{{ $question->id }}-options" />
                                                                  @break
                                                                  @case("time")
                                                                  <input required type="text" class="form-control timepicker" value="{{ @test_res($test_result->id, $question->id)->option_id }}"  placeholder="time" name="{{ $question->id }}-options" />
                                                                  @break
                                                                  @case("file_upload")
                                                ...
                                                {{-- @if (count($userAnswers) == 0) --}}
                                                    <div class="form-group row justify-content-center"
                                                        ...
                                                        <div class="col-4" style="    margin-right: 46%;">
