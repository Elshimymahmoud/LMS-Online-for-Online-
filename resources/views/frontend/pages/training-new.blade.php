...
@push('after-styles')
  ...
  <link rel="stylesheet" href="{{asset('iv')}}/css/training.css">
@endpush
...
@section('content')
    ...
    <section class="slide"
        style="background-image: url({{ asset('ivory') }}/assets/img/slider/8.jpg);">
 ...
 <section class="services-about services-why">
    <div class="services-about-overlay">
        <div class="container-about">
            <div class="services-about-conetnt part2">
                <div class="row">
                    <div class="container">
    ...
    <section class="slide"
        style="    background-size: contain;background-image: url({{ asset('ivory') }}/assets/img/slider/9.jpg);height: 255px;">
        <div class="slide-overlay">
            <div class="slide-content">
                ...
                margin-top: 100px;
                margin-right: 245px;
            ">CHANGE IS INEVITABLE. WE ANTICIPATE IT.</h1>
            </div>
        </div>
    </section>
                                                                    ...
                                                                    <div class="bold_timeline_item_inner">
                                                                        <div class="bold_timeline_item_header">
                                                                            <div class="bold_timeline_item_header_inner">
                                                                                ...
                                                                                <h2
                                                                                    class="bold_timeline_item_header_title">
