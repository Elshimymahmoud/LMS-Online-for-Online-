...
@section('content')
    ...
    <section class="slide"
        style="background-size:contain;;background-image: url({{ asset('ivory') }}/assets/img/slider/8.jpg);">
    ...
    <section class="slide"
        style="background-image: url({{ asset('ivory') }}/assets/img/slider/9.jpg);height: 255px;">
        <div class="slide-overlay">
            <div class="slide-content">
