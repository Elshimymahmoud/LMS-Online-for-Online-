                ...
                <div class="--dark-theme" id="chat">
                    <div class="chat__conversation-board">
                        @foreach($ticket->messages as $message)
                            ...
                            @elseif($ticket->admin_id && $message->user_id == $ticket->admin_id)
                                {{-- Admin msg --}}
                        ...
                        <form>
                            <div class="chat__conversation-panel">
                                ...
                                <div class="chat__conversation-panel__container">
                                    <input type="hidden" name="ticket_id" value="{{ $ticket->code }}"/>
                        ...
                        <div class="chat__conversation-panel">
                            <div class="chat__conversation-panel__container">
                                <input class="chat__conversation-panel__input panel-item"
                                       value="@lang('labels.frontend.tickets.fields.closed')" disabled/>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            $('#chat form').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var message = '<div class="chat__conversation-board__message-container">\n' +
                            '                                    <div class="chat__conversation-board__message__person">\n' +
                            '                                        <div class="chat__conversation-board__message__person__avatar">\n' +
                            ...
                            '                                    </div>\n' +
                            '                                </div>';
                        $('#chat .chat__conversation-board').append(message);
