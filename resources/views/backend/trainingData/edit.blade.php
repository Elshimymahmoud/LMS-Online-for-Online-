...
@endpush
@section('content')
    {{ html()->form('Put', route('admin.trainingData.update',['id'=>$trainingData->id]))->id('trainingData-create')->class('form-horizontal')->acceptsFiles()->open() }}
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    ...
                    {!! Form::text('name', $trainingData->name, ['class' => 'form-control ']) !!}
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    ...
                    {!! Form::text('name_ar', $trainingData->name_ar, ['class' => 'form-control ']) !!}
            ...
            <div class="form-group row justify-content-center">
                <div class="col-4">
                    ...
                    <button class="btn btn-success pull-right" type="submit">{{__('buttons.general.crud.update')}}</button>
                </div>
            </div><!--col-->
        </div>
    </div>
