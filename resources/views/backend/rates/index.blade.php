    ...
    <div class="card" style="margin-top: 2%;">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.forms.create',['form_type'=>request('form_type'),'course_id'=>request('course_id')]) }}"
                            ...
                            @foreach($rates as $key=>$item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.forms.edit',['id'=>$item->id,'form_type'=>$item->form_type,'course_id'=>request('course_id')]) }}" class="btn btn-xs btn-info mb-1"><i class="icon-pencil"></i></a>
                                       
                                        <!-- <a href="{{route('admin.results.index', ['forms_id' => $item->id,'form_type' => $item->form_type,'course_id'=>request('course_id'),'student_id'=>@$student_id])}}?param1=value1&param2=value2&param3=value3" class="btn btn-xs btn-warning mb-1"><i class="icon-check"></i></a> -->
                                        <a href="{{route('admin.results.index', ['forms_id' => $item->id,'form_type' => $item->form_type,'course_id'=>request('course_id'),'student_id'=>@$student_id])}}&forms_id={{$item->id}}" class="btn btn-xs btn-warning mb-1"><i class="icon-check"></i></a>
