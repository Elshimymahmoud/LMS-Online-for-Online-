                        ...
                        <table id="myTable" class="table table-bordered table-striped ">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('labels.backend.rates.fields.user')</th>
                                    <th>@lang('labels.backend.rates.fields.average')</th>

                                    <th>@lang('labels.backend.rates.fields.show')</th>
                            ...
                            <tbody>
                                @foreach ($rates as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (Lang::locale() == 'en') {{ $course->title }} @else  {{ $course->title_ar }} @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            {{ rate_average($item->user->id, $course->id) }}
                                        </td>

                                        <td>
                                            {{-- <a href="{{route('admin.question.create', ['rate_id' => $item->id])}}" class="btn btn-success mb-1"><i class="fa fa-plus-circle"></i></a> --}}
                                            <a href="{{ route('admin.userQuestion.show', ['user_id' => $item->user->id,'course_id' => $course->id]) }}"
                                                class="btn mb-1 btn-warning text-white"><i
                                                    class="fa fa-arrow-right"></i></a>
                                        </td>
                                        {{-- <td>
                                        <a href="{{route('admin.rate.edit',['id'=>$item->id]) }}"
                                        ...
                                        <a data-method="delete" data-trans-button-cancel="Cancel"
                                           ...
                                           onclick="$(this).find('form').submit();">
                                            ...
                                            <form action="{{route('admin.rate.destroy',['id'=>$item->id])}}"
