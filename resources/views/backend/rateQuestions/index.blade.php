    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.question.create',['rate_id'=>$rate->id]) }}"
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.rates.fields.questions_type')</th>
                            ...
                            <tbody>
                            @foreach($rate->RateQuestion as $key=>$item)
                                @php $key++ @endphp
                                <tr>
                                    <td>
                                        {{ $key }}
                                    ...
                                    <td> {{  __('labels.backend.rates.'.$item->question_type) }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a data-method="delete" data-trans-button-cancel="Cancel"
                                           ...
                                           onclick="$(this).find('form').submit();">
                                            ...
                                            <form action="{{route('admin.question.destroy',['id'=>$item->id])}}"
