...
@endpush
@section('content')
    {{ html()->form('PUT', route('admin.question.update',['id'=>$rateQuestion->id]))->id('question-create')->class('form-horizontal')->acceptsFiles()->open() }}
    ...
    <div class="card-body">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-10">
                ...
                ->value($rateQuestion->question_ar)
                    ->class('form-control')
        ...
        <div class="row form-group">
            ...
            <div class="col-md-10">
                ...
                <input type="radio" name="question_type" id="radio" value="radio" id="" onchange="changeRequiredAttr(this)"  @if($rateQuestion->question_type=='radio') checked @endif)>
                {{ Form::label('radio', __('labels.backend.rates.radio')) }}               
                <br>
                <input type="radio" name="question_type" id="text" value="text" id="" onchange="changeRequiredAttr(this)" @if($rateQuestion->question_type=='text') checked @endif>
        ...
        {{-- <div class="row form-group">
            ...
            <div class="col-md-10">
                ...
                {{ html()->textarea('question_option')
                    ->class('form-control')
                    ->value($rateQuestion->question_option)
                    ->id('question_option')
        ...
        <div class="row form-group">
            ...
            <div class="col-md-10">
                ...
                {{ html()->textarea('question_option_ar')
                    ...
                    ->value($rateQuestion->question_option_ar)
