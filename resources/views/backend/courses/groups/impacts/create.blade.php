...
@endpush
@section('content')
    {{ html()->form('POST', route('admin.groups.impacts.store'))->id('impact-create')->class('form-horizontal')->acceptsFiles()->open() }}
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    {!! Form::text('impact', old('impact'), ['class' => 'form-control ']) !!}
                </div>
                <!--col-->
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    {!! Form::text('impact_ar', old('impact_ar'), ['class' => 'form-control ']) !!}
                </div>
            </div>
