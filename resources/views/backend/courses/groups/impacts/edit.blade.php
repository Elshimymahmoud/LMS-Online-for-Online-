...
@endpush
@section('content')
    {!! Form::model($impact, ['method' => 'PUT', 'route' => ['admin.impacts.update', "id"=> $impact->id],'files' => true]) !!}

{{--    {{ html()->form('PUT', route('admin.impacts.update', ['id' => $impact->id]))->id('impact-edit')->class('form-horizontal')->acceptsFiles()->open() }}--}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    {!! Form::text('impact_ar', old('impact_ar'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.tests.fields.title_ar')]) !!}
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    {!! Form::text('impact', old('impact'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.tests.fields.title')]) !!}
                </div>
                <!--col-->
            </div>
            {{--  --}}
            ...
            <div class="form-group row justify-content-center">
                <div class="col-4">
                    {{ form_cancel(route('admin.group.impacts'), __('buttons.general.cancel')) }}
