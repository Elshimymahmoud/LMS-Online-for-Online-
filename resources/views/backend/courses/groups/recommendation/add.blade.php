...
@section('title', __('buttons.backend.programRec.addToGroup').' | '.app_name())
@push('after-styles')
...
@endif
{!! Form::open(['method' => 'POST', 'route' => ['admin.group.rec.attach']]) !!}

    <div class="card" style="margin-top: 2%;">
        <div class="card-header">
            <h3 class="page-title d-inline float-left mb-0">@lang('buttons.backend.programRec.addToGroup')</h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('recommendations',trans('labels.backend.programRec.title'), ['class' => 'control-label']) !!}
                    {!! Form::select('recommendations[]', $recommendations ,old('recommendations'), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple', 'required' => true]) !!}
                </div>
                <div class="col-12 form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".js-example-placeholder-multiple").select2({
                placeholder: "{{trans('labels.backend.programRec.fields.choose_rec')}}",
            });
