...
@section('title', __('labels.backend.rates.division.edit') . ' | ' . app_name())
...
@endpush
@section('content')
    {!! Form::model($division, ['method' => 'PUT', 'route' => ['admin.groups.rate.division.update', "division"=> $division->id],'files' =>true])  !!}
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('labels.backend.rates.division.edit')</h3>
            <div class="float-right">
                <a href="{{ route('admin.groups.rates.divisions', ['rate'=>$division->rate->id]) }}" class="btn
                btn-success">@lang('labels.backend.rates.division.view')</a>
                                        ...
                                        @switch($question->question_type)
                                            ...
                                            @case('radio')
                                                <input type="text" class="form-control" autocomplete="off"
                                                       style="color:#000"  value="{{ trans('labels.backend.questions.fields.radio') }}" disabled="">
                                                @break
                                            @default:
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".add_question").click(function(){
                count_question++;
                var selectedValue = $('select[name=user_type]').val();
