...
@section('title', __('labels.backend.courses.create_group').' | '.app_name())
@push('after-styles')
    <style>
        .link-wrapper {
...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.groups.store'], 'files' => true,'enctype'=>"multipart/form-data"]) !!}

    <div class="card" style="      font-family: 'Cairo', sans-serif;">
        <div class="card-header">
            <h3 class="page-title float-left">@lang('labels.backend.courses.create_group')</h3>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select name="course_id" id="course_id" class="form-control" required>
                    <option>@lang('labels.backend.courses.course-title')</option>
                    @foreach($courses as $course)
                        <option value="{{ $course->id }}">{{ app()->getLocale() == "ar" ? $course->title_ar :
                        $course->title }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="course_description" rows="5" required>
                </textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="course_type" disabled required>
                </textarea>
            </div>
            ...
            <div class="form-group">
                {!! Form::label('place', trans('labels.backend.hall.name').' *', ['class' => 'control-label']) !!}<br>
...
{{--            <div class="form-group">--}}
{{--                {!! Form::label('number_hours',trans('labels.backend.courses.fields.number_hours'), ['class' => 'control-label']) !!}--}}
{{--                <input class="form-control" name="number_hours" type="number">--}}
{{--            </div>--}}
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="flex-row" id="date-container">
                    <div class="form-group{{ $errors->has('from_datetime') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input type="datetime-local" value="{{ Request::old('from_datetime') ?: '' }}" id="date" name="from_datetime" class="form-control col-md-10 col-xs-12 w-100" required>
                    ...
                    <div class="form-group{{ $errors->has('to_datetime') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input type="datetime-local" value="{{ Request::old('to_datetime') ?: '' }}" id="date" name="to_datetime" class="form-control col-md-10 col-xs-12" required>
            ...
            <div class="col-12 form-group">
                ...
                {!! Form::select('coordinator[0][]', $coordinators, old('coordinator_id'), ['class' => 'form-control select2 js-example-placeholder-multiple-coord', 'multiple' => 'multiple']) !!}
            </div>


            <div class="col-12 form-group">
                {!! Form::label('teachers',trans('labels.backend.courses.fields.teachers'), ['class' => 'control-label']) !!}
                {!! Form::select('teachers[0][]', $teachers, old('teachers'), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple']) !!}
            </div>

            <div class="col-12 form-group">
                {!! Form::label('students',trans('labels.backend.courses.fields.students'), ['class' => 'control-label']) !!}
                {!! Form::select('students[0][]', $students, old('students'), ['class' => 'form-control select2 js-example-placeholder-multiple-student', 'multiple' => 'multiple']) !!}
            </div>

            <div class="col-12 form-group">
                {!! Form::label('clients',trans('labels.backend.courses.fields.client'), ['class' => 'control-label']) !!}
                {!! Form::select('clients[0][]', $clients, old('clients'), ['class' => 'form-control select2 js-example-placeholder-multiple-client', 'multiple' => 'multiple']) !!}
            </div>
{{--            <div class="col-12 form-group">--}}
{{--                {!! Form::label('tests',trans('labels.backend.tests.title'), ['class' => 'control-label']) !!}--}}
{{--                {!! Form::select('tests[0][]', $tests, old('tests'), ['class' => 'form-control select2 js-example-placeholder-multiple-student', 'multiple' => 'multiple', 'required' => true]) !!}--}}
{{--            </div>--}}
            <div class="col-12 form-group">
                {!! Form::label('impacts',trans('labels.backend.impact.title'), ['class' => 'control-label']) !!}
                {!! Form::select('impacts[0][]', $impacts, old('impacts'), ['class' => 'form-control select2 js-example-placeholder-multiple-student', 'multiple' => 'multiple', 'required' => true]) !!}
            </div>
            <div class="col-12 form-group">
                {!! Form::label('rates',trans('labels.backend.rates.fields.rateStudent'), ['class' => 'control-label']) !!}
                {!! Form::select('rates[0][]', $rates, old('rates'), ['class' => 'form-control select2 js-example-placeholder-multiple-student', 'multiple' => 'multiple', 'required' => true]) !!}
            </div>
            <div class="col-12 form-group">
                {!! Form::label('rateTeacher',trans('labels.backend.rates.fields.teacher_rate_student'), ['class' =>
                'control-label']) !!}
                {!! Form::select('rateTeacher[0][]', $rateTeacher, old('rateTeacher'), ['class' => 'form-control select2
                js-example-placeholder-multiple-student', 'multiple' => 'multiple', 'required' => true]) !!}
            </div>
            <div class="col-12 form-group">
                {!! Form::label('reccomendations',trans('labels.backend.programRec.title'), ['class' => 'control-label']) !!}
                {!! Form::select('reccomendations[0][]', $reccomendations, old('reccomendations'), ['class' => 'form-control select2 js-example-placeholder-multiple-student', 'multiple' => 'multiple', 'required' => true]) !!}
            </div>
            <div class="col-12 form-group">
                {!! Form::label('cert_templates',trans('labels.backend.cert_templates.add'), ['class' =>
                'control-label']) !!}
                {!! Form::select('cert_templates', $cert_templates, old('cert_templates'), ['class' => 'form-control', 'required' => true]) !!}
            </div>
                    ...
                    .then(data => {
                        ...
                        if(data.locations){
                            ...
                            if(data.course_type == 'Live Online Training'){
                                //mark locationSelect2 as required
                                locationSelect2.required = true;
