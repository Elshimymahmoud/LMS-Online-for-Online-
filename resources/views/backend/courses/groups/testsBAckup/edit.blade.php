        ...
        <div class="card-body">
            <div class="row">
                 <div class="col-12 col-lg-6 form-group">
                    ...
                    {!! Form::select('course_id', $courses, old('course_id') ?? $test->course, ['class' => 'form-control select2', 'disabled']) !!}
                </div>
                ...
                <div class="col-lg-12 form-group">
                    {!! Form::label('course_location_label', trans('labels.backend.hall.fields.location').'*', ['class' => 'control-label']) !!}
                    {!! Form::select('course_location_id[]', $courseLocations,$test->courseLocations, ['class' => 'form-control select2 col-12 col-lg-12 ','required'=>true]) !!}
