   ...
   <div class="row">
       ...
       <div id="contentCardsContainer">
           @foreach($contents as $content)
               <div class="content-card" data-index="{{ $loop->iteration - 1 }}" data-content="{{ $content->id }}">
                   <div style="display: flex; justify-content: space-between;">
                       <p>{{ $content->title }}</p>
                       <a class="removeMainContentBtn">x</a>
                   </div>
                   <div class="sub-content-input">
                       <input type="text" placeholder="@lang('labels.backend.courses.fields.sub_content')"
                              class="subContentInput">
                   ...
                   <div class="sub-contents">
                       ...
                       @foreach($content->subContents as $subContent)
                           <div>
                               <div style="display:flex; justify-content: space-between;">
                                   <input type="text" style="margin:0; flex-grow: 1;" value="{{ $subContent->title }}" class="form-control subContentTitleInput" />
                                   <a class="removeSubContentBtn">x</a>
                               </div>
                           </div>
                       @endforeach
                   </div>
   ...
   <div class="row">
    ...
    <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" name="resourceLinks" id="resourceLinks" value="@foreach($course->resources as $resource){{ $loop->last ? $resource->title . '|' . $resource->link : $resource->title . '|' . $resource->link . ',' }}@endforeach">
            </div>
        ...
        {!! Form::text('slug', old('slug'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.slug_placeholder')]) !!}
            ...
            <div class="row">
                {{-- <div class="col-12 col-lg-3 form-group">
                    ...
                    {!! Form::number('price', old('price'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.courses.fields.price')]) !!}
                </div> --}}
            ...
            <div class="row">
                ...
                <br>
                    ...
                    @if ($course->mediavideo && $course->mediavideo->url != null)
{{--                        @if ($course->mediavideo && $course->mediaVideo->url)--}}
{{--                            @php--}}
{{--                                $filePath = Storage::url('uploads/' . $course->mediaVideo->file_name);--}}
...
{{--                            </video>--}}
{{--                            @if($course->mediavideo && $course->mediavideo->type == 'youtube')--}}
                                <a href="{{$course->mediavideo->url}}" target="_blank"> {{$course->mediavideo->file_name}}</a>
{{--                            @endif--}}
{{--                        @endif--}}

                    @endif
{{--                    @if($course->mediavideo && $course->mediavideo->type == 'youtube')--}}
{{--                       <a href="{{$course->mediavideo->url}}" target="_blank"> youtube</a>--}}
{{--                    @endif--}}

{{--                    @if($course->mediavideo && $course->mediavideo->type == 'vimeo')--}}
{{--                        <a href="{{$course->mediavideo->url}}" target="_blank"> vimeo</a>--}}
{{--                    @endif--}}
{{--                    <br>--}}
    ...
    'value'=>old('add_file'),
            ...
            <div class="row">
{{--                @if ($course->mediaPdf && $course->mediaPdf->file_name)--}}
{{--                    <a href="{{ asset('storage/uploads/' . $course->mediaPdf->file_name) }}" target="_blank">--}}
{{--                        PDF--}}
{{--                    </a>--}}
{{--                @else--}}
...
{{--                @endif--}}
                @if($course->mediaPDF)
                    <p class="form-group">
                        <a href="{{ asset('storage/uploads/'.$course->mediaPDF->name) }}"
                           target="_blank">{{ $course->mediaPDF->name }}
                            ({{ $course->mediaPDF->size }} KB)</a>
                        <iframe src="{{asset('storage/uploads/'.$course->mediaPDF->name)}}" width="100%" height="500px">
                        </iframe>
                    </p>
                @endif
                        ...
                        <div class="dropdown-content" aria-labelledby="dropdownMenuButton1" dir="ltr">
                            <label class="two">
                                <div class="checkbox-wrapper-26">
                                    ...
                                    {!! Form::checkbox('published', 1, $course->published == 1, []) !!}
                            ...
                            <label class="two">
                                <div class="checkbox-wrapper-26">
                                    ...
                                    {!! Form::checkbox('featured', 1, $course->featured == 1, []) !!}
                                    <label for="_checkbox-26">
                                        <div class="tick_mark"></div>
                                    </label>
                                </div>
                            ...
                            <label class="two">
                                <div class="checkbox-wrapper-26">
                                    ...
                                    {!! Form::checkbox('trending', 1, $course->trending == 1, []) !!}
                                    <label for="_checkbox-26">
                                        <div class="tick_mark"></div>
                                    </label>
                                </div>
            ...
            {{-- <div class="row">
                        <div class="col-12 form-check">
                            ...
                            <div class="checkbox d-inline mr-4">
                                {!! Form::checkbox('rates[]', $rate->id,[], []) !!}
                                {!! Form::label($rate->name, (Lang::locale()=='en')?$rate->name:($rate->name_ar?$rate->name_ar:$rate->name), ['class' => 'checkbox control-label font-weight-bold']) !!}
                            </div>
                            @endforeach
                        </div>
                    </div> --}}
...
{{--                    <h5 class="rate-title" style="color: #000;"> </h5>--}}
{{--                    <div class="dropdown">--}}
{{--                        <button class="dropdown-toggle" type="button" id="dropdownMenuButton2" aria-haspopup="true" aria-expanded="false">--}}
{{--                            تقيم المدرب--}}
{{--                        </button>--}}
{{--                        <div class="dropdown-content" aria-labelledby="dropdownMenuButton2" dir="">--}}

{{--                            @foreach ($rates->where('type','teacher') as $rate)--}}
{{--                                <label class="two">--}}
{{--                                    <div class="checkbox-wrapper-26">--}}
{{--                                        {!! Form::checkbox('forms[]', $rate->id,$course->forms()->where('form_type', 'rate')->get()->pluck('id')->toArray(), []) !!}--}}
{{--                                        <label for="_checkbox-26">--}}
{{--                                            <div class="tick_mark"></div>--}}
{{--                                        </label>--}}
{{--                                    </div>--}}
{{--                                    <b>{{(Lang::locale()=='en')?$rate->title:($rate->title_ar?$rate->title_ar:$rate->title)}}</b>--}}
{{--                                </label>--}}
{{--                            @endforeach--}}
...
{{--                                    @foreach ($impactMeasurments  as $rate)--}}
{{--                                        <label class="two">--}}
{{--                                            <div class="checkbox-wrapper-26">--}}
{{--                                                {!! Form::checkbox('forms[]', $rate->id,$course->impactMeasurment()->pluck('id')->toArray(), []) !!}--}}
{{--                                                <label for="_checkbox-26">--}}
{{--                                                    <div class="tick_mark"></div>--}}
{{--                                                </label>--}}
{{--                                            </div>--}}
...
{{--                                        </label>--}}
{{--                                    @endforeach--}}
{{--                                    @foreach ($programRecommendation  as $rate)--}}
{{--                                        <label class="two">--}}
{{--                                            <div class="checkbox-wrapper-26">--}}
{{--                                                {!! Form::checkbox('forms[]', $rate->id, $course->programRecommendations()->get()->pluck('id')->toArray(),[]) !!}--}}
{{--                                                <label for="_checkbox-26">--}}
{{--                                                    <div class="tick_mark"></div>--}}
{{--                                                </label>--}}
{{--                                            </div>--}}
...
{{--            </div>--}}
            ...
            <!-- <div class="row">
      <div class="col-12 form-group">
        @foreach ($programRecommendation as $program)
                <div class="checkbox d-inline mr-4">

{!! Form::checkbox('forms[]', $program->id, []) !!}
                {!! Form::label($program->title, (Lang::locale()=='en')?$program->title:($program->title_ar?$program->title_ar:$program->title), ['class' => 'checkbox control-label font-weight-bold']) !!}
                </div>
...
{{--                <div class="col-12 form-group">--}}
{{--                    {!! Form::label('timeline', trans('labels.backend.courses.fields.timeline'), ['class' => 'control-label']) !!}--}}
{{--                    {!! Form::textarea('timeline', old('timeline'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.timeline')]) !!}--}}
{{--                </div>--}}
{{--                <div class="col-12 form-group">--}}
{{--                    {!! Form::label('timeline_ar', trans('labels.backend.courses.fields.timeline_ar'), ['class' => 'control-label']) !!}--}}
{{--                    {!! Form::textarea('timeline_ar', old('timeline_ar'), ['class' => 'form-control editor_ar', 'placeholder' => trans('labels.backend.courses.fields.timeline_ar')]) !!}--}}
{{--                </div>--}}
...
@push('after-scripts')
    ...
    <script>
        $(document).ready(function() {
            // Assuming `existingCourseContents` is passed from the server as a JSON string
            @php
                $contentsArray = $contents->toArray() ;
                  $formattedContents = array_map(function($content) {
                      return [
                          'mainContent' => $content['title'],
                          'subContents' => array_map(function($subContent) {
                                return ['title' => $subContent['title']];
                          }, $content['sub_contents']),
                          'mainContentId' => $content['id'],
                  ];
                  }, $contentsArray);
//                  dd($formattedContents);
            @endphp
            let existingCourseContents = @json($formattedContents); // This should be replaced with actual data
            let courseContents = existingCourseContents.length > 0 ? existingCourseContents : [];

            function updateCourseContentsDisplay() {
                $('#contentCardsContainer').empty();
                courseContents.forEach((content, index) => {
                    const card = $('<div>').addClass('content-card').attr('data-index', index);
                    const header = $('<div>').css('display', 'flex').css('justify-content', 'space-between');
                    const titleInput = $('<input>').attr('type', 'text').css('margin', '0').css('flex-grow', '1').val(content.mainContent).addClass('form-control mainContentTitleInput');
                    const removeMainBtn = $('<a>').addClass('removeMainContentBtn').text('x');
                    header.append(titleInput, removeMainBtn);
                    const subContentInputDiv = $('<div>').addClass('sub-content-input');
                    const subContentInput = $('<input>').attr('type', 'text').attr('placeholder', 'Enter sub content').addClass('subContentInput');
                    const addSubBtn = $('<a>').addClass('addSubContentBtn').text('+');
                    subContentInputDiv.append(subContentInput, addSubBtn);
                    const subContentsDiv = $('<div>').addClass('sub-contents');
                    content.subContents.forEach(sub => {
                        const subContentDiv = $('<div>').css('display', 'flex').css('justify-content', 'space-between');
                        const subContentTitleInput = $('<input>').attr('type', 'text').css('margin', '0').css('flex-grow', '1').val(sub.title).addClass('form-control subContentTitleInput');
                        const removeSubBtn = $('<a>').addClass('removeSubContentBtn').text('x');
                        subContentDiv.append(subContentTitleInput, removeSubBtn);
                        subContentsDiv.append(subContentDiv);
                    });
                    card.append(header, subContentInputDiv, subContentsDiv);
                    $('#contentCardsContainer').append(card);
                });
            }

            // Function to update courseContents based on input changes
            function updateSubContentTitle(mainIndex, subIndex, newTitle) {
                if (courseContents[mainIndex] && courseContents[mainIndex].subContents[subIndex]) {
                    courseContents[mainIndex].subContents[subIndex].title = newTitle;
                }
            }

            // Attach event listener to sub-content input fields
            $(document).on('change', '.subContentTitleInput', function() {
                const mainContentIndex = $(this).closest('.content-card').data('index');
                const subContentIndex = $(this).parent().parent().index(); // Assuming each sub-content input is wrapped in a parent container that correctly reflects the sub-content's index
                const newTitle = $(this).val();
                console.log("sa", mainContentIndex, subContentIndex)
                // Update the JSON data structure
                updateSubContentTitle(mainContentIndex, subContentIndex, newTitle);
            });

            $('#addContentBtn').click(function() {
                const mainContentTitle = $('#mainContentInput').val();
                if (mainContentTitle) {
                    courseContents.push({ mainContent: mainContentTitle, subContents: [] });
                    $('#mainContentInput').val('');
                    updateCourseContentsDisplay();
                }
            });

            $(document).on('click', '.addSubContentBtn', function() {
                const mainContentIndex = $(this).closest('.content-card').data('index');
                const subContentTitle = $(this).prev('.subContentInput').val();
                if (subContentTitle) {
                    courseContents[mainContentIndex].subContents.push({ title: subContentTitle });
                    $(this).prev('.subContentInput').val('');
                    updateCourseContentsDisplay();
                }
            });

            $(document).on('click', '.removeMainContentBtn', function() {
                const indexToRemove = $(this).closest('.content-card').data('index');
                courseContents = courseContents.filter((_, index) => index !== indexToRemove);
                updateCourseContentsDisplay();
            });

            $(document).on('click', '.removeSubContentBtn', function() {
                const mainContentIndex = $(this).closest('.content-card').data('index');
                const subContentIndex = $(this).parent().index();
                courseContents[mainContentIndex].subContents.splice(subContentIndex, 1);
                updateCourseContentsDisplay();
            });

            $('form').submit(function(e) {
                e.preventDefault();
                $('#courseContentsJson').val(JSON.stringify(courseContents));
                this.submit();
            });
        });
    </script>
