            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <div class="col-12 form-group">
                        ...
                        {!! Form::select('location_id', $locations, $courseLocation->location->id, ['class' => 'form-control select2','id'=>'locations', 'multiple' => false, 'required' => true]) !!}
                    </div>
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        ...
                        {!! Form::select('Course_clints[0][]', $Course_clints, old('CoursClint_id',$courseLocation-> CoursClint_id), ['class' => 'form-control select2 js-example-placeholder-multiple-coord', 'multiple' => true]) !!}
                    </div>
...
{{--                    </div>--}}
                <div class="col-12 col-lg-6  form-group">
                            ...
                            {!! Form::select('place', $course_place_unit, $courseLocation->place, ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required' => false]) !!}
                ...
                <div class="col-12 col-lg-12 form-group" id='days[0][days]'>
                    ...
                    {{$LocationDays[$index]->name_ar}}<input type="checkbox" checked name="daysAr[0][days][{{$index}}]" value="{{$LocationDays[$index]->name_ar}}" id="">
                         <input type="hidden" name="daysEn[0][days][{{$index}}]" value="{{$LocationDays[$index]->name}}" id="">
                ...
                <div class="col-lg-6 form-group">
                    ...
                    {!! Form::text('fromTime' ,$courseLocation->from_time, ['class' => 'form-control  js-example-placeholder-',   'required' => true,]) !!}
                </div>
                <div class="col-lg-6 form-group">
                    {!! Form::label('toTime', 'التوقيت الي', ['class' => 'control-label']) !!}
                    {!! Form::text('toTime' ,$courseLocation->to_time, ['class' => 'form-control  js-example-placeholder-',   'required' => true,]) !!}
                </div>
                <div class="col-lg-12 form-group">
            ...
            <div class="row">
                <div class="col-12   form-group" style="text-align:left;">
                    ...
                    {!! Form::submit(trans('strings.backend.general.app_update'), ['class' => 'btn btn-lg btn-danger edit']) !!}
                </div>
            </div>
        </div>
    </div>
