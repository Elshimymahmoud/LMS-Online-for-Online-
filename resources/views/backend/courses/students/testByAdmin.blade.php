...
@section('title', __('menus.backend.forms.rate') . ' | ' . app_name())
@push('after-styles')
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">
          ...
          <li class="breadcrumb-item active" aria-current="page">
                ...
                {{session('locale')=='ar'?$rates[0]->title_ar:$rates[0]->title}}
          </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        ...
                        <div class="rates content">
                            {{ html()->form('POST', route('admin.answerEvaluateTest.byAdmin'))->id('rate-create')->class('form-horizontal')->acceptsFiles()->open() }}
                            ...
                            <div id="accordion">
                                ...
                                @foreach ($rates as $rate)
                                    ...
                                    $userAnswers = $test_result?$test_result->answers:[];
                                ...
                                @endphp
                                    ...
                                    <div class="card0">
                                        ...
                                        <div class="card-header0" id="heading{{ $rate->id }}">
                                            <h5 class="mb-0 card-body dark-red">
                                                        ...
                                                        @if ($question->question_type == 'radio')
                                                            ...
                                                            <div style="direction: ltr;display: inline-block;width: 100%">
                                                                <input name="{{ $question->id }}-options" id="kartik"
                                                                    ...
                                                                    title="" data-rtl=1 value="{{$quest_answer?$quest_answer->answer:0}}" />
                                                            </div>
