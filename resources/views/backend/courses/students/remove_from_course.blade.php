...
@section('title', __('buttons.backend.access.users.removeFromCourse').' | '.app_name())
@push('after-styles')
...
@endif
    {!! Form::open(['method' => 'POST', 'route' => ['admin.courses.removeStudentsFromCourse'], 'files' => true,]) !!}

    <div class="card" style="margin-top: 2%;">
        <div class="card-header">
            <h3 class="page-title d-inline float-left mb-0">@lang('buttons.backend.access.users.removeFromCourse')</h3>
