    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.forms.create',['form_type'=>'impact_measurments']) }}"
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.impact.fields.impact_title')</th>
                                <th>@lang('labels.backend.impact.fields.impact_title_ar')</th>
                            ...
                            @foreach($impacts as $key=>$item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       {{__('labels.backend.impact.fields.teacher')}}
                                      
                                           
                                       @else
                                       {{__('labels.backend.impact.fields.student')}}
