...
@endpush
@section('content')
    {{ html()->form('POST', route('admin.forms.store', ['form_type' => 'impact_measurments','course_id'=>request('course_id')]))->id('impact-create')->class('form-horizontal')->acceptsFiles()->open() }}
    ...
    <div class="card">
        <div class="card-header">
            ...
            <!-- <a href="{{ request('course_id')?(route('admin.forms2.index2',['form_type'=>'impact_measurments','course_id'=>request('course_id')])):(route('admin.forms.index',['form_type'=>'impact_measurments'])) }}" class="btn btn-primary">&#8592</a> -->
