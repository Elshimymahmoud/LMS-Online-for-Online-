        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    ...
                    {!! Form::select('tests[]', $tests, old('tests')??request('forms_id'), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('tests'))
                        <p class="help-block">
                            {{ $errors->first('tests') }}
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 form-group">
                    ...
                    {!! Form::text('option_text_' . $question, old('option_text'), ['class' => 'form-control ', 'rows' => 3]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-12 form-group">
                    ...
                    {!! Form::text('explanation_' . $question, old('explanation_'.$question), ['class' => 'form-control ', 'rows' => 3]) !!}
                    <p class="help-block"></p>
