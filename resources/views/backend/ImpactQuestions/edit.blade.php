...
@endpush
@section('content')
    {{ html()->form('PUT', route('admin.ImpactQuestions.update',['id'=>$impactQuestion->id]))->id('question-create')->class('form-horizontal')->acceptsFiles()->open() }}
    ...
    <div class="card-body">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-10">
                ...
                ->value($impactQuestion->question_ar)
                    ->class('form-control')
        ...
        <div class="form-group row justify-content-center">
            <div class="col-4">
                {{ form_cancel(route('admin.ImpactQuestions.index'), __('buttons.general.cancel')) }}
