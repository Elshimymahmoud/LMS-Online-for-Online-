...
<div class="form-group countrySelection">
    ...
    <div class="col-sm-10">
        @if(Lang::locale()=='ar')
            <select onchange="checkNationality(e)" name="country" id="countrySelection" class="form-control gds-cr" country-data-region-id="gds-cr-one" country-data-default-value="{{$user?$user->country:''}}" data-language="ar"></select>
        @else
            <select onchange="checkNationality(e)" name="country" id="countrySelection" class="form-control gds-cr" country-data-region-id="gds-cr-one" country-data-default-value="{{$user?$user->country:''}}" data-language="en"></select>
        @endif
    </div>
</div>
<div class="form-group gds-cr-one">
    ...
    <div class="col-sm-10">
        @if(Lang::locale()=='ar')
            <select name="city" class="form-control" id="gds-cr-one" region-data-default-value="{{$user?$user->city:''}}" data-language="ar"></select>
        @else
            <select name="city" class="form-control" id="gds-cr-one" region-data-default-value="{{$user?$user->city:''}}" data-language="en"></select>
        @endif
    </div>
</div>
