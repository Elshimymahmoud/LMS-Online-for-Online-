...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            $route = route('admin.forms.get_data2',['show_deleted' => $show_deleted,'course_id' => $course_id,'form_type'=>'test','course_location_id'=>$course_location_id,'student_id'=>$student_id]);
            @endphp
