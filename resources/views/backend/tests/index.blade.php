...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.forms.get_data')}}';
            ...
            $route = route('admin.forms.get_data',['show_deleted' => $show_deleted,'course_id' => $course_id,'form_type'=>'test','course_location_id'=>$course_location_id]);
            @endphp
