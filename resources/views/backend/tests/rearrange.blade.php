                ...
                <div class="col-12 col-lg-12 form-group">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-12  ">
                            ...
                            @if (is_object($test) && sizeof($test) > 0)
                            ...
                            <a href="{{ request('form_type') == 'group_test' ? route('admin.courses.groups.tests.index', ['group'=> $group]) : route('admin.forms2.index2', ['course_id' => request('course_id'), 'form_type'=>'test'])  }}"
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '#save_timeline', function (e) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{route('admin.forms.saveSequence')}}",
                    data: {
                        _token: '{{csrf_token()}}',
                        list: list
                    }
