...
@section('content')
@php
   $id=$achivment?$achivment->id:0 
@endphp
    {!! Form::model($achivment, ['method' => 'PUT', 'route' => ['admin.acheivment.update', $id], 'files' => true,]) !!}

    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">@lang('labels.backend.acheivment.edit')</h3>
            <div class="float-right">
                <a href="{{ route('admin.acheivment.index') }}"
                   class="btn btn-success">@lang('labels.backend.acheivment.view')</a>
