        ...
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 form-group">
                    ...
                    {!! Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => 'English', 'required' => false]) !!}
                    {!! Form::text('title_ar', old('title_ar'), ['class' => 'form-control', 'placeholder' => 'Arabic', 'required' => false]) !!}
                ...
                <div class="col-12 form-group">
                    ...
                    {!! Form::textarea('content_ar', old('content_ar'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.reasons.fields.content_ar'), 'required' => false]) !!}
