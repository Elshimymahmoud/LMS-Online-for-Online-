...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{  url()->previous() }}"
                    class="btn btn-primary">&#8592</a></div>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td>{{ Lang::locale()=='en'?$lesson->course->title: $lesson->course->title_ar}}</td>
                        </tr>
                        <tr>
                            <th>@lang('labels.backend.lessons.fields.title_ar')</th>
                            <td>{{ Lang::locale()=='en'?$lesson->title:$lesson->title_ar }}</td>
                        </tr>
                        <tr>
                            <th>@lang('labels.backend.lessons.fields.title')</th>
                            <td>{{ Lang::locale()=='en'?$lesson->title:$lesson->title }}</td>
                        </tr>
{{--                        <tr>--}}
...
{{--                        <tr>--}}
{{--                            <th>@lang('labels.backend.lessons.fields.short_text_ar')</th>--}}
{{--                            <td>{!! $lesson->short_text_ar !!}</td>--}}
{{--                        </tr>--}}
{{--                        <tr>--}}
...
{{--                        </tr>--}}
                        <tr>
                            <th>@lang('labels.backend.lessons.fields.full_text_ar')</th>
                            <td>{!! $lesson->full_text_ar !!}</td>
                        </tr>
                        <tr>
