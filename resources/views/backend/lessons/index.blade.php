        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-6 form-group">
                    ...
                    {!! Form::select('course_location_id[]', $courseLocations,'', ['class' => 'form-control select2 col-12 col-lg-12  js-example-placeholder-single2','placeholder'=>' ','required'=>true,'id'=>'course_location_id']) !!}
...
@push('after-scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $route = route('admin.lessons.get_data',['show_deleted' => $show_deleted,'course_id' => $course_id,'course_location_id'=>$course_location_id,'chapter_id'=>$chapter_id]);
            @endphp
