    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 form-group">
                    {!! Form::label('title_ar', trans('labels.backend.bundles.fields.title_ar').' *', ['class' => 'control-label']) !!}
                    {!! Form::text('title_ar', old('title_ar'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.bundles.fields.title_ar'), 'required' => false]) !!}
                </div>
                <div class="col-12 col-lg-12 form-group">
            ...
            <div class="row">
                ...
                <div class="col-12 form-group">
                    ...
                    {!! Form::textarea('description', old('description'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.bundles.fields.description')]) !!}

                </div>
                <div class="col-12 form-group">
                    {!! Form::label('description_ar',  trans('labels.backend.bundles.fields.description_ar'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('description_ar', old('description_ar'), ['class' => 'form-control editor_ar', 'placeholder' => trans('labels.backend.bundles.fields.description_ar')]) !!}
