...
@section('title', __('menus.backend.sidebar.certificates.abrove_online').' | '.app_name())
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="page-title ">@lang('menus.backend.sidebar.certificates.abrove_online')</h3>
            <!-- <div class="float-right">
                    <a href="{{ route('admin.cirtificate.abroveonline_all') }}"
                                    ...
                                    $('#checkbox{{$key}}').on('change', function() {
                                        ...
                                        route = '{{route('admin.certificates.updateshow',['certificate_id'=>'id'])}}';
                                            ...
                                            $.ajax({
                                                    ...
                                                    window.location.href = "{{route('admin.all_certificates.abrove_certificate_online')}}"
                                                    },
                                                    error:function(){
                                                        console.log("error");
                                                        window.location.href = "{{route('admin.all_certificates.abrove_certificate_online')}}"
