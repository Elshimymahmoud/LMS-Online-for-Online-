            ...
            <div class="tab-content">
                ...
                <div id="general" class="tab-pane container active">
                    <div class="row mt-4 mb-4">
                        <div class="col ">
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.vat_number'))->class('col-md-2 form-control-label')->for('vat_number') }}

                                <div class="col-md-10">
                                    {{ html()->text('vat__number')
                                        ->class('form-control')
                                        ->placeholder(__('labels.backend.general_settings.vat_number'))
                                        ->attribute('maxlength', 191)

                                        ->value(config('vat.number'))
                                        ->autofocus()
                                        }}
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.provider_name'))->class('col-md-2
                                form-control-label')->for('provider_name') }}

                                <div class="col-md-10">
                                    {{ html()->text('provider__name')
                                        ->class('form-control')
                                        ->placeholder(__('labels.backend.general_settings.provider_name'))
                                        ->attribute('maxlength', 191)
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.font'))->class('col-md-2 form-control-label')->for('font') }}

                                <div class="col-md-10">
                                    <select name="google_font" id="google_font" class="form-control">
                                        @foreach($font_names as $font)
                                            <option value="{{$font}}" @if(config('google_font') == $font) selected @endif>{{$font}}</option>
                                        @endforeach
                                    </select>
                                </div><!--col-->
                            </div><!--form-group-->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-10" >
                                    ...
                                    {!! Form::textarea('pixel_code', config('pixel_code'), ['class' => 'form-control ', 'placeholder' => trans('labels.backend.general_settings.pixel_code')]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="counter-container" id="counter-container">
                                        <br>
                                        <label for="total_students">{{__('labels.backend.general_settings.total_students')}}</label>
                                        ...
                                        <br>
                                        <label for="total_students">{{__('labels.backend.general_settings.total_courses')}}</label>
                                        ...
                                        <br>
                                        <label for="total_students">{{__('labels.backend.general_settings.total_hours')}}</label>
                                        <input type="text" required class="form-control mb-2" id="total_hours"  name="total_hours"  placeholder="{{__('labels.backend.general_settings.total_hours')}}">
                                        <br>
                                        <label for="total_students">{{__('labels.backend.general_settings.total_years')}}</label>
                                        <input type="text" required class="form-control mb-2" id="total_years"  name="total_years"  placeholder="{{__('labels.backend.general_settings.total_years')}}">
                                    </div>
                ...
                <div id="logos" class="tab-pane container fade">
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            <div class="row form-group">
                                {{ html()->label(__('labels.backend.logo.primary_logo_ar'))->class('col-md-2
                                form-control-label')->for('primary_logo_ar_image') }}

                                <div class="col-md-10 ">
                                    {!! Form::file('primary_logo_ar_image', ['class' => 'form-control d-inline-block',
                                    'placeholder' => '','id' => 'primary_logo_ar_image', 'accept' => 'image/jpeg,image/gif,image/png', 'data-preview'=>'#primary_logo_ar_image_preview']) !!}
                                    <p class="help-text mb-0 font-italic">{!!  __('labels.backend.logo.primary_logo_note')!!}</p>
                                </div>
                                <div class="col-md-8 offset-md-2">
                                    <div id="primary_logo_ar_image_preview" class="d-inline-block p-3 preview">
                                        <img height="50px" src="{{asset('storage/logos/'.config('primary_logo_ar_image'))}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                {{ html()->label(__('labels.backend.logo.primary_logo_en'))->class('col-md-2
                                form-control-label')->for('primary_logo_en_image') }}

                                <div class="col-md-10 ">
                                    {!! Form::file('primary_logo_en_image', ['class' => 'form-control d-inline-block',
                                    'placeholder' => '','id' => 'primary_logo_en_image', 'accept' => 'image/jpeg,image/gif,image/png', 'data-preview'=>'#primary_logo_en_image_preview']) !!}
                                    <p class="help-text mb-0 font-italic">{!!  __('labels.backend.logo.primary_logo_note')!!}</p>
                                </div>
                                <div class="col-md-8 offset-md-2">
                                    <div id="primary_logo_en_image_preview" class="d-inline-block p-3 preview">
                                        <img height="50px" src="{{asset('storage/logos/'.config('primary_logo_en_image'))}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                {{ html()->label(__('labels.backend.logo.footer_ar'))->class('col-md-2 form-control-label')
                                ->for('favicon_image') }}

                                <div class="col-md-10">
                                    {!! Form::file('footer_image_ar', ['class' => 'form-control d-inline-block',
                                    'placeholder' => '', 'data-preview'=>'#footer_image_ar_preview', 'accept' => 'image/jpeg,image/gif,image/png']) !!}
                                    <p class="help-text mb-0 font-italic">{!!  __('labels.backend.logo.footer_note')!!}</p>
                                </div>
                                <div class="col-md-8 offset-md-2">
                                    <div id="footer_image_ar_preview" class="d-inline-block p-3 preview">
                                        <img height="50px" src="{{asset('storage/logos/'.config('footer_image_ar'))}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                {{ html()->label(__('labels.backend.logo.footer_en'))->class('col-md-2 form-control-label')
                                ->for('favicon_image') }}

                                <div class="col-md-10">
                                    {!! Form::file('footer_image_en', ['class' => 'form-control d-inline-block',
                                    'placeholder' => '', 'data-preview'=>'#footer_image_en_preview', 'accept' => 'image/jpeg,image/gif,image/png']) !!}
                                    <p class="help-text mb-0 font-italic">{!!  __('labels.backend.logo.footer_note')!!}</p>
                                </div>
                                <div class="col-md-8 offset-md-2">
                                    <div id="footer_image_en_preview" class="d-inline-block p-3 preview">
                                        <img height="50px" src="{{asset('storage/logos/'.config('footer_image_en'))}}">
                                    </div>
                                </div>
                            </div>
                ...
                <div id="payment_settings" class="tab-pane container fade">
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            {{-- /////// --}}
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.myfatoorah'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('myfatoorah__active', config('myfatoorah.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')

                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
                                        <a target="_blank" href="https://myfatoorah.readme.io/docs"
                                           class="float-right font-italic font-weight-bold">{{ __('labels.backend.general_settings.payment_settings.how_to_myfatoorah')}}</a>
                                    </div>
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.myfatoorah_note')}}</i>
                                    </small>
                                    <div class="switch-content @if(config('myfatoorah.active') == 0 || config('myfatoorah.active') == false) d-none @endif">
                                        <br>
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.mode'))->class('col-md-2 form-control-label') }}
                                            <div class="col-md-8 col-xs-12">
                                                <select class="form-control" id="myfatoorah_settings_mode"
                                                        name="myfatoorah__settings__mode">
                                                    <option selected
                                                            value="sandbox">{{__('labels.backend.general_settings.payment_settings.sandbox')}}</option>
                                                    <option value="live">{{__('labels.backend.general_settings.payment_settings.live')}}</option>
                                                </select>
                                                <span class="help-text font-italic">{!!  __('labels.backend.general_settings.payment_settings.myfatoorah_mode_note') !!}</span>
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_id'))->class('col-md-2 form-control-label') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('myfatoorah__client_id')
                                                     ->class('form-control')
                                                     ->value(config('myfatoorah.client_id'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_secret'))->class('col-md-2 form-control-label')->for('myfatoorah.myfatoorah.secret') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('myfatoorah__secret')
                                                     ->class('form-control')
                                                     ->value(config('myfatoorah.secret'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                    </div>
                            ...
                            {{-- START Tabby Pay --}}
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.tabby'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('tabby__active', config('tabby.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')

                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
                                        <a target="_blank" href="https://api-docs.tabby.ai/"
                                           class="float-right font-italic font-weight-bold">{{ __('labels.backend.general_settings.payment_settings.how_to_tabby')}}</a>
                                    </div>
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.tabby_note')}}</i>
                                    </small>
                                    <div class="switch-content @if(config('tabby.active') == 0 || config('tabby.active') == false) d-none @endif">
                                        <br>
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_secret'))->class('col-md-2 form-control-label')->for('tabby.tabby.secret') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('tabby__secret')
                                                     ->class('form-control')
                                                     ->value(config('tabby.secret'))
                                                     }}
                                            </div><!--col-->
                                        </div>
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.merchant_code'))->class('col-md-2 form-control-label')->for('tabby.tabby.secret') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('tabby__merchant_code')
                                                     ->class('form-control')
                            ...
                            {{-- START Jeel Pay --}}
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.jeel'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('jeel__active', config('jeel.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')

                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
                                        <a target="_blank" href="https://docs.jeel.co/"
                                           class="float-right font-italic font-weight-bold">{{ __('labels.backend.general_settings.payment_settings.how_to_jeel')}}</a>
                                    </div>
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.jeel_note')}}</i>
                                    </small>
                                    <div class="switch-content @if(config('jeel.active') == 0 || config('jeel.active') == false) d-none @endif">
                                        <br>
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_secret'))->class('col-md-2 form-control-label')->for('jeel.jeel.secret') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('jeel__secret')
                                                     ->class('form-control')
                                                     ->value(config('jeel.secret'))
                                                     }}
                                            </div><!--col-->
                                        </div>
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.merchant_code'))->class('col-md-2 form-control-label')->for('jeel.jeel.secret') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->text('jeel__merchant_code')
                                                     ->class('form-control')
                                                     ->value(config('jeel.merchant_code'))
                                                     }}
                                            </div><!--col-->
                                        </div>
                                    </div>
...
@push('after-scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#total_hours').val("{{config('total_hours')}}");
            $('#total_years').val("{{config('total_years')}}");
            @else
