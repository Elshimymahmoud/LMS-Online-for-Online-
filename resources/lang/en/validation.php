...
return array (
  ...
  'complete-data'=>'plz Filling yor personal Data',
  'attributes' => 
  array (
    'frontend' => 
    array (
      'binary_name'=>'Is Binary Name?',
      ...
      'action' => 'action',
      'no_action' => 'No action',
      'allow_personal_info' => 'Allow personal info',
      'male' => 'Male',
      'female' => 'Female',
      'other' => 'Other',
      'password' => 'Password',
      ...
      'last_name' => 'Second Name In English',
      'third_name' => 'Third Name In English',
      'fourth_name' => 'Last Name In English',
      'first_name_ar'=>'First Name IN Arabic',
      'sec_name_ar'=>'Second Name In Arabic',
      'third_name_ar'=>'Third Name In Arabic',
      'fourth_name_ar'=>'Last Name In Arabic',
      ...
      'residency_number'=>'Residency ID',
      'passport-num'=>'Passport Number',
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'send_email_to_user'=>' Send Email With User Data  ',
  ...
  array (
    ...
    array (
      ...
      'cert_templates' => [
          'required' => 'The certificate template is required.',
      ],
      'from_datetime' => [
          'required' => 'The start date and time are required.',
      ],
      'to_datetime' => [
          'required' => 'The end date and time are required.',
      ],
      'location2' => [
