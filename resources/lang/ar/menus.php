...
return array (
  ...
  array (
    'access' => 
    array (
      'activation_msg'=>'من فضلك اضغط علي رابط التفعيل لارسال بريد الكتروني',
      'activation_resend'=>'أعد إرسال بريد التفعيل',
      'roles' => 
      array (
        'all' => 'كل الأدوار',
        'create' => 'إنشاء دور',
  ...
  'courseHomeFree'=>array(
    'title'=>'البرنامج المجاني في الرئيسية '
  ),
      'account' => 
      array (
        'title' => 'الحساب',
      ...
      array (
        ...
        'title' => 'الدورات',
        'circulum' => 'محتوى الدورة',
        'createLocation'=>'انشاء مكان للدورة',
        'editLocation'=>'تعديل مكان الدورة',
        'invitation'=>'الدعوات',
        'no_location'=>'لم يتم اضافه مجموعه بعد ',
        'locations_times'=>'الاماكن و المواعيد',
        'landing'=>'صفحة الهبوط',
        'courses_include'=>'محتوي الدوره ',
        'editCourse' => 'تعديل الدوره '
      ...
      array (
        'title' => 'شهادات',
        'abrov'=>'موافقه',
        'abroveall'=>'الموافقه علي الشهادات',
        'abrove'=>'الموافقه علي الشهادات الحضوريه',
        'abrove_online'=>' الموافقه علي الشهادات الاونلاين',
        'abrove_all'=>' الموافقه علي  الجميع',
      ...
      array (
        'title' => 'فصول الدورة',
        'location' => 'مكان الدوره',
      ),
      'rates' => 
      array (
        'title' => 'تقييم الدورات',
        'title_group' => 'تقييم المجموعات',
        'createRate' => 'انشاء تقييم',
        'createRateType' => 'انشاء نوع تقييم',
      ),
      'impact'=>array(
        'title' => 'قياس الآثر',
        'createImpact' => 'انشاء قياس الآثر',
      ...
      'programRec'=>array(
        'title' => 'توصيات البرنامج',
        'group_title' => 'توصيات المجموعات',
        'createProgram' => 'انشاء نموذج توصيه للبرنامج',
      ),
      'trainingData'=>array(
        'title' => ' نموذج المدربين ',
        'createTrainingData' => 'انشاء نموذج مدربين',
      ),
      'forms'=>array(
        'title' => 'النماذج ',
      ),
    ...
    'forms'=>array(
      'test'=>'الاختبارات',
      'rate'=>'التقييمات',
      'training_data'=>'بيانات نموذج المتدربين',
      'complainment'=>'الشكاوي',
      'impact_measurments'=>'قياس الاثر',
      'program_recommendation'=>'توصيات البرنامج',
      'create'=>'انشاء',
      'edit'=>'تعديل'
